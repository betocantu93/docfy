...
module('FastBoot | docs', function (hooks) {
  ...
  test('it renders the docs nav', async function (assert) {
    ...
    assert
      ...
      .hasText(
        'Welcome to Docfy Introduction Installation Overview @docfy/core Overview Helpers genereateFlatOutput genereateNestedOutput prysmex-docfy-ember Working with Ember Installation Components Docfy Link Component Docfy Output Component'
      );
  });
